...
export default function WhyChooseSection() {
  ...
  return (
    <section className="py-12 md:py-32 px-6 md:px-12 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {reasons.map((reason, idx) => (
            ...
            >
              <div className="w-14 h-14 md:w-20 md:h-20 mx-auto mb-5 md:mb-8 rounded-full bg-background border border-border flex items-center justify-center group-hover:bg-primary/10 group-hover:border-primary/30 transition-all duration-500">
              ...
              <h3 className="font-heading italic font-light text-xl md:text-3xl text-foreground mb-3 md:mb-4">
                {reason.title}
              </h3>
